...
class CustomReferenceResponse(BaseModel):
    """
    CustomReferenceResponse
    """ # noqa: E501
    raw_response: Optional[Any]
    references: List[SimplifiedLocation]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "references": [SimplifiedLocation.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None
        })
        return _obj
